...
If you already have {remotes} installed, you can move on to the next step.

If you are not sure whether you have it installed, you can run this function, which will install the newest version of {remotes} if you do not already have it.
